...
emp_name varchar(50),	
position_on	varchar(50),
salary int,	
branch_id varchar(10)
);
-- Insert values into each employees table
INSERT INTO employee(emp_id, emp_name, position_on, salary, branch_id) 
VALUES
...
INSERT INTO books(isbn, book_title, category, rental_price, status_of, author, publisher) 
VALUES
...
-- inserting into issued_status values --
